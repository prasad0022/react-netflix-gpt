  ...
  return (
    <div className="w-180 p-20 mt-40 text-white">
      ...
      <div className="mt-6 text-xl inline-block">
        <button className="bg-[rgba(6,2,2,0.65)] hover:bg-white text-white hover:text-black font-medium w-35 px-4 py-2 rounded-lg transition duration-300 cursor-pointer">
          Play
        </button>
